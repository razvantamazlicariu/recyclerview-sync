 ...
 */
public class PinchZoomItemTouchListener extends RecyclerView.OnScrollListener implements RecyclerView.OnItemTouchListener, ScaleGestureDetector.OnScaleGestureListener {
    ...
    public boolean onScale(ScaleGestureDetector detector) {
        ...
        ChildRecyclerViewAdapter adapter = (ChildRecyclerViewAdapter) mRecyclerView.getAdapter();
        float scaling = adapter.getScaling() + 0.5f;
        float scale = Math.max(0, getSpan(detector) - mSpan) * (mPreviousSpan < mSpan ? -0.5f : 0.5f);
        Log.e("##OFFSET", "computedOffset: " + mRecyclerView.computeHorizontalScrollOffset() + "scaling: " + scaling);
        adapter.setScaling(scaling);
    ...
    public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
        ...
        offSetX += dx;
        Log.e("##OFFSET", "Scrolled: " + offSetX + "computedOffset: " + recyclerView.computeHorizontalScrollOffset());
    }
